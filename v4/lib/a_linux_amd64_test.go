...
var testExecKnownFails = map[string]struct{}{
	...
	`assets/github.com/vnmakarov/mir/c-tests/lacc/line-directive.c`:      {}, // EXEC FAIL
	`assets/github.com/vnmakarov/mir/c-tests/lacc/pointer.c`:             {}, // EXEC FAIL
	...
	`assets/gcc-9.1.0/gcc/testsuite/gcc.c-torture/execute/pr42570.c`:                   {}, // BUILD FAIL: exit status 2
	`assets/gcc-9.1.0/gcc/testsuite/gcc.c-torture/execute/pr67037.c`:                   {}, // BUILD FAIL: exit status 2
	`assets/gcc-9.1.0/gcc/testsuite/gcc.c-torture/execute/pr79286.c`:                   {}, // BUILD FAIL: exit status 2
	`assets/gcc-9.1.0/gcc/testsuite/gcc.c-torture/execute/zerolen-1.c`:                 {}, // BUILD FAIL: exit status 2
	`assets/github.com/gcc-mirror/gcc/gcc/testsuite/gcc.c-torture/execute/pr42570.c`:   {}, // BUILD FAIL: exit status 2
	`assets/github.com/gcc-mirror/gcc/gcc/testsuite/gcc.c-torture/execute/pr67037.c`:   {}, // BUILD FAIL: exit status 2
	`assets/github.com/gcc-mirror/gcc/gcc/testsuite/gcc.c-torture/execute/pr79286.c`:   {}, // BUILD FAIL: exit status 2
	...
	//TODO
	`assets/benchmarksgame-team.pages.debian.net/fasta-4.c`:                                             {}, // COMPILE FAIL: fasta-4.c.go:4699:4: undefined reference to 'errx' (ccgo.go:263:Main: link.go:246:link: link.go:614:link)
	...
	`assets/ccgo/bug/struct.c`:                                                                          {}, // COMPILE FAIL: TODO PostfixExpressionSelect (expr.go:455:expr0: expr.go:1361:postfixExpression: expr.go:1783:postfixExpressionSelect)
	...
	`assets/ccgo/bug/union.c`:                                                                           {}, // COMPILE FAIL: TODO exprSelect (expr.go:2400:primaryExpression: expr.go:433:expr0: expr.go:2088:assignmentExpression)
	...
	`assets/gcc-9.1.0/gcc/testsuite/gcc.c-torture/compile/20000804-1.c`:                                 {}, // COMPILE FAIL: TODO *cc.PredefinedType _Complex long long _Complex long long (expr.go:2182:assignmentExpression: type.go:35:typ: type.go:141:typ0)
	...
	`assets/gcc-9.1.0/gcc/testsuite/gcc.c-torture/compile/20001222-1.c`:                                 {}, // COMPILE FAIL: TODO cc.Complex128Value (expr.go:457:expr0: expr.go:2390:primaryExpression: expr.go:2658:primaryExpressionFloatConst)
	...
	`assets/gcc-9.1.0/gcc/testsuite/gcc.c-torture/compile/991213-1.c`:                                   {}, // COMPILE FAIL: TODO UnaryExpressionImag (expr.go:2400:primaryExpression: expr.go:463:expr0: expr.go:1150:unaryExpression)
	...
	`assets/gcc-9.1.0/gcc/testsuite/gcc.c-torture/compile/complex-5.c`:                                  {}, // COMPILE FAIL: TODO *cc.PredefinedType _Complex int _Complex int (expr.go:2645:primaryExpressionIntConst: type.go:29:helper: type.go:141:typ0)
	...
	`assets/gcc-9.1.0/gcc/testsuite/gcc.c-torture/compile/complex-6.c`:                                  {}, // COMPILE FAIL: TODO *cc.PredefinedType _Complex int _Complex int (expr.go:2645:primaryExpressionIntConst: type.go:29:helper: type.go:141:typ0)
	`assets/gcc-9.1.0/gcc/testsuite/gcc.c-torture/compile/ex.c`:                                         {}, // COMPILE FAIL: ex.c:12:19: too few arguments to function 'foo', type 'function(int, int) returning int' in 'foo ()' (expr.go:455:expr0: expr.go:1358:postfixExpression: expr.go:1952:postfixExpressionCall)
	...
	`assets/gcc-9.1.0/gcc/testsuite/gcc.c-torture/compile/mangle-1.c`:                                   {}, // COMPILE FAIL: TODO *cc.UnknownValue (expr.go:457:expr0: expr.go:2388:primaryExpression: expr.go:2625:primaryExpressionIntConst)
	...
	`assets/gcc-9.1.0/gcc/testsuite/gcc.c-torture/compile/pass.c`:                                       {}, // COMPILE FAIL: pass.c:13:10: too many arguments to function 'foo', type 'function(int, int, int) returning int' in 'foo ((int) & q, q, w, e, q, (int) &w)' (expr.go:455:expr0: expr.go:1358:postfixExpression: expr.go:1957:postfixExpressionCall)
	...
	`assets/gcc-9.1.0/gcc/testsuite/gcc.c-torture/compile/pr35431.c`:                                    {}, // COMPILE FAIL: TODO *cc.PredefinedType _Complex int _Complex int (expr.go:2645:primaryExpressionIntConst: type.go:29:helper: type.go:141:typ0)
	...
	`assets/gcc-9.1.0/gcc/testsuite/gcc.c-torture/compile/pr38123.c`:                                    {}, // COMPILE FAIL: unsupported va_arg type: struct (expr.go:2400:primaryExpression: expr.go:463:expr0: expr.go:1069:unaryExpression)
	`assets/gcc-9.1.0/gcc/testsuite/gcc.c-torture/compile/pr38360.c`:                                    {}, // COMPILE FAIL: pr38360.c:7:3: too few arguments to function 'fputs', type 'function(pointer to char, pointer to void) returning int' in 'fputs ("")' (expr.go:455:expr0: expr.go:1358:postfixExpression: expr.go:1952:postfixExpressionCall)
	...
	`assets/gcc-9.1.0/gcc/testsuite/gcc.c-torture/compile/pr39845.c`:                                    {}, // COMPILE FAIL: TODO exprUintptr (expr.go:455:expr0: expr.go:1363:postfixExpression: expr.go:1680:postfixExpressionPSelect)
	...
	`assets/gcc-9.1.0/gcc/testsuite/gcc.c-torture/compile/pr44038.c`:                                    {}, // COMPILE FAIL: TODO (expr.go:457:expr0: expr.go:2396:primaryExpression: expr.go:2513:primaryExpressionStringConst)
	...
	`assets/gcc-9.1.0/gcc/testsuite/gcc.c-torture/compile/pr47428.c`:                                    {}, // COMPILE FAIL: pr47428.c:24:3: too few arguments to function 'fn', type 'function(int, int) returning int' in 'fn (0)' (expr.go:455:expr0: expr.go:1358:postfixExpression: expr.go:1952:postfixExpressionCall)
	...
	`assets/gcc-9.1.0/gcc/testsuite/gcc.c-torture/compile/pr51694.c`:                                    {}, // COMPILE FAIL: pr51694.c:14:3: too few arguments to function 'foo', type 'function(int, pointer to function())' in 'foo (x)' (expr.go:455:expr0: expr.go:1358:postfixExpression: expr.go:1952:postfixExpressionCall)
	...
	`assets/gcc-9.1.0/gcc/testsuite/gcc.c-torture/compile/pr54559.c`:                                    {}, // COMPILE FAIL: TODO cc.Complex64Value (expr.go:457:expr0: expr.go:2390:primaryExpression: expr.go:2658:primaryExpressionFloatConst)
	...
	`assets/gcc-9.1.0/gcc/testsuite/gcc.c-torture/compile/pr85704.c`:                                    {}, // COMPILE FAIL: pr85704.c:3:1: invalid type size: -1 (type.go:385:structLiteral: type.go:52:typ0: type.go:369:checkValidType)
	...
	`assets/gcc-9.1.0/gcc/testsuite/gcc.c-torture/compile/pr86122.c`:                                    {}, // COMPILE FAIL: TODO *cc.PredefinedType _Complex int _Complex int (expr.go:2182:assignmentExpression: type.go:35:typ: type.go:141:typ0)
	`assets/gcc-9.1.0/gcc/testsuite/gcc.c-torture/compile/pr86123.c`:                                    {}, // COMPILE FAIL: TODO *cc.PredefinedType _Complex unsigned _Complex unsigned (expr.go:2645:primaryExpressionIntConst: type.go:29:helper: type.go:141:typ0)
	...
	`assets/gcc-9.1.0/gcc/testsuite/gcc.c-torture/compile/struct-non-lval-3.c`:                          {}, // COMPILE FAIL: TODO exprLvalue (expr.go:2400:primaryExpression: expr.go:433:expr0: expr.go:2088:assignmentExpression)
	`assets/gcc-9.1.0/gcc/testsuite/gcc.c-torture/compile/uuarg.c`:                                      {}, // COMPILE FAIL: uuarg.c:4:10: too few arguments to function 'foo', type 'function(int, int, int, int, int, int, int, int, int) returning int' in 'foo ()' (expr.go:455:expr0: expr.go:1358:postfixExpression: expr.go:1952:postfixExpressionCall)
	...
	`assets/gcc-9.1.0/gcc/testsuite/gcc.c-torture/execute/20020412-1.c`:                                 {}, // COMPILE FAIL: unsupported va_arg type: struct (expr.go:2400:primaryExpression: expr.go:463:expr0: expr.go:1069:unaryExpression)
	...
	`assets/gcc-9.1.0/gcc/testsuite/gcc.c-torture/execute/20030714-1.c`:                                 {}, // COMPILE FAIL: TODO PostfixExpressionSelect (expr.go:455:expr0: expr.go:1361:postfixExpression: expr.go:1792:postfixExpressionSelect)
	...
	`assets/gcc-9.1.0/gcc/testsuite/gcc.c-torture/execute/20030910-1.c`:                                 {}, // COMPILE FAIL: TODO UnaryExpressionReal (expr.go:2400:primaryExpression: expr.go:463:expr0: expr.go:1152:unaryExpression)
	...
	`assets/gcc-9.1.0/gcc/testsuite/gcc.c-torture/execute/20070614-1.c`:                                 {}, // COMPILE FAIL: TODO cc.Complex64Value (expr.go:457:expr0: expr.go:2390:primaryExpression: expr.go:2658:primaryExpressionFloatConst)
	...
	`assets/gcc-9.1.0/gcc/testsuite/gcc.c-torture/execute/920625-1.c`:                                   {}, // COMPILE FAIL: unsupported va_arg type: struct (expr.go:2400:primaryExpression: expr.go:463:expr0: expr.go:1069:unaryExpression)
	...
	`assets/gcc-9.1.0/gcc/testsuite/gcc.c-torture/execute/920908-1.c`:                                   {}, // COMPILE FAIL: unsupported va_arg type: struct (expr.go:2400:primaryExpression: expr.go:463:expr0: expr.go:1069:unaryExpression)
	...
	`assets/gcc-9.1.0/gcc/testsuite/gcc.c-torture/execute/931004-10.c`:                                  {}, // COMPILE FAIL: unsupported va_arg type: struct (expr.go:2400:primaryExpression: expr.go:463:expr0: expr.go:1069:unaryExpression)
	`assets/gcc-9.1.0/gcc/testsuite/gcc.c-torture/execute/931004-12.c`:                                  {}, // COMPILE FAIL: unsupported va_arg type: struct (expr.go:2400:primaryExpression: expr.go:463:expr0: expr.go:1069:unaryExpression)
	`assets/gcc-9.1.0/gcc/testsuite/gcc.c-torture/execute/931004-14.c`:                                  {}, // COMPILE FAIL: unsupported va_arg type: struct (expr.go:2400:primaryExpression: expr.go:463:expr0: expr.go:1069:unaryExpression)
	`assets/gcc-9.1.0/gcc/testsuite/gcc.c-torture/execute/931004-2.c`:                                   {}, // COMPILE FAIL: unsupported va_arg type: struct (expr.go:2400:primaryExpression: expr.go:463:expr0: expr.go:1069:unaryExpression)
	`assets/gcc-9.1.0/gcc/testsuite/gcc.c-torture/execute/931004-4.c`:                                   {}, // COMPILE FAIL: unsupported va_arg type: struct (expr.go:2400:primaryExpression: expr.go:463:expr0: expr.go:1069:unaryExpression)
	`assets/gcc-9.1.0/gcc/testsuite/gcc.c-torture/execute/931004-6.c`:                                   {}, // COMPILE FAIL: unsupported va_arg type: struct (expr.go:2400:primaryExpression: expr.go:463:expr0: expr.go:1069:unaryExpression)
	`assets/gcc-9.1.0/gcc/testsuite/gcc.c-torture/execute/931004-8.c`:                                   {}, // COMPILE FAIL: unsupported va_arg type: struct (expr.go:2400:primaryExpression: expr.go:463:expr0: expr.go:1069:unaryExpression)
	...
	`assets/gcc-9.1.0/gcc/testsuite/gcc.c-torture/execute/960416-1.c`:                                   {}, // COMPILE FAIL: 960416-1.c:57:23: internal error: t_be (expr.go:2388:primaryExpression: expr.go:2645:primaryExpressionIntConst: type.go:27:helper)
	...
	`assets/gcc-9.1.0/gcc/testsuite/gcc.c-torture/execute/991014-1.c`:                                   {}, // COMPILE FAIL: 991014-1.c:10:1: invalid type size: -496 (type.go:385:structLiteral: type.go:52:typ0: type.go:369:checkValidType)
	...
	`assets/gcc-9.1.0/gcc/testsuite/gcc.c-torture/execute/align-1.c`:                                    {}, // COMPILE FAIL: align-1.c:1:13: unsupported alignment 16 of new_int (type.go:17:typedef: type.go:52:typ0: type.go:340:checkValidType)
	`assets/gcc-9.1.0/gcc/testsuite/gcc.c-torture/execute/anon-1.c`:                                     {}, // COMPILE FAIL: TODO PostfixExpressionSelect (expr.go:455:expr0: expr.go:1361:postfixExpression: expr.go:1783:postfixExpressionSelect)
	...
	`assets/gcc-9.1.0/gcc/testsuite/gcc.c-torture/execute/builtin-bitops-1.c`:                           {}, // COMPILE FAIL: builtin-bitops-1.c.go:1603:6: undefined reference to '__builtin_parity' (ccgo.go:263:Main: link.go:246:link: link.go:614:link)
	`assets/gcc-9.1.0/gcc/testsuite/gcc.c-torture/execute/builtin-types-compatible-p.c`:                 {}, // COMPILE FAIL: TODO *cc.InvalidType (expr.go:455:expr0: expr.go:1358:postfixExpression: expr.go:1937:postfixExpressionCall)
	...
	`assets/gcc-9.1.0/gcc/testsuite/gcc.c-torture/execute/complex-2.c`:                                  {}, // COMPILE FAIL: TODO cc.Complex128Value (expr.go:457:expr0: expr.go:2390:primaryExpression: expr.go:2658:primaryExpressionFloatConst)
	`assets/gcc-9.1.0/gcc/testsuite/gcc.c-torture/execute/complex-5.c`:                                  {}, // COMPILE FAIL: TODO cc.Complex64Value (expr.go:457:expr0: expr.go:2390:primaryExpression: expr.go:2658:primaryExpressionFloatConst)
	`assets/gcc-9.1.0/gcc/testsuite/gcc.c-torture/execute/complex-7.c`:                                  {}, // COMPILE FAIL: TODO cc.Complex64Value (expr.go:457:expr0: expr.go:2390:primaryExpression: expr.go:2658:primaryExpressionFloatConst)
	`assets/gcc-9.1.0/gcc/testsuite/gcc.c-torture/execute/complex-6.c`:                                  {}, // COMPILE FAIL: TODO cc.Complex128Value (expr.go:457:expr0: expr.go:2390:primaryExpression: expr.go:2658:primaryExpressionFloatConst)
	...
	`assets/gcc-9.1.0/gcc/testsuite/gcc.c-torture/execute/frame-address.c`:                              {}, // COMPILE FAIL: frame-address.c.go:358:39: undefined reference to '__builtin_alloca' (ccgo.go:263:Main: link.go:246:link: link.go:614:link)
	...
	`assets/gcc-9.1.0/gcc/testsuite/gcc.c-torture/execute/ieee/fp-cmp-4.c`:                              {}, // COMPILE FAIL: fp-cmp-4.c.go:342:5: undefined reference to '__builtin_islessequal' (ccgo.go:263:Main: link.go:246:link: link.go:614:link)
	`assets/gcc-9.1.0/gcc/testsuite/gcc.c-torture/execute/ieee/fp-cmp-5.c`:                              {}, // COMPILE FAIL: fp-cmp-5.c.go:356:9: undefined reference to '__builtin_isgreaterequal' (ccgo.go:263:Main: link.go:246:link: link.go:614:link)
	`assets/gcc-9.1.0/gcc/testsuite/gcc.c-torture/execute/ieee/fp-cmp-4l.c`:                             {}, // COMPILE FAIL: fp-cmp-4l.c.go:367:5: undefined reference to '__builtin_isgreaterequal' (ccgo.go:263:Main: link.go:246:link: link.go:614:link)
	`assets/gcc-9.1.0/gcc/testsuite/gcc.c-torture/execute/ieee/fp-cmp-4f.c`:                             {}, // COMPILE FAIL: fp-cmp-4f.c.go:381:5: undefined reference to '__builtin_islessgreater' (ccgo.go:263:Main: link.go:246:link: link.go:614:link)
	`assets/gcc-9.1.0/gcc/testsuite/gcc.c-torture/execute/ieee/fp-cmp-8.c`:                              {}, // COMPILE FAIL: fp-cmp-8.c.go:340:5: undefined reference to '__builtin_isless' (ccgo.go:263:Main: link.go:246:link: link.go:614:link)
	...
	`assets/gcc-9.1.0/gcc/testsuite/gcc.c-torture/execute/ieee/fp-cmp-8f.c`:                             {}, // COMPILE FAIL: fp-cmp-8f.c.go:340:5: undefined reference to '__builtin_isless' (ccgo.go:263:Main: link.go:246:link: link.go:614:link)
	...
	`assets/gcc-9.1.0/gcc/testsuite/gcc.c-torture/execute/pr39228.c`:                                    {}, // COMPILE FAIL: pr39228.c.go:329:9: undefined reference to '__builtin_isinf' (ccgo.go:263:Main: link.go:246:link: link.go:614:link)
	...
	`assets/gcc-9.1.0/gcc/testsuite/gcc.c-torture/execute/pr44575.c`:                                    {}, // COMPILE FAIL: unsupported va_arg type: struct (expr.go:2400:primaryExpression: expr.go:463:expr0: expr.go:1069:unaryExpression)
	...
	`assets/gcc-9.1.0/gcc/testsuite/gcc.c-torture/execute/pr49644.c`:                                    {}, // COMPILE FAIL: TODO cc.Complex128Value (expr.go:457:expr0: expr.go:2390:primaryExpression: expr.go:2658:primaryExpressionFloatConst)
	...
	`assets/gcc-9.1.0/gcc/testsuite/gcc.c-torture/execute/pr80692.c`:                                    {}, // COMPILE FAIL: TODO *cc.PredefinedType _Decimal64 _Decimal64 (expr.go:2654:primaryExpressionFloatConst: type.go:29:helper: type.go:141:typ0)
	...
	`assets/gcc-9.1.0/gcc/testsuite/gcc.c-torture/execute/printf-2.c`:                                   {}, // COMPILE FAIL: printf-2.c.go:4513:8: undefined reference to 'freopen' (ccgo.go:263:Main: link.go:246:link: link.go:614:link)
	`assets/gcc-9.1.0/gcc/testsuite/gcc.c-torture/execute/stdarg-3.c`:                                   {}, // COMPILE FAIL: unsupported va_arg type: struct (expr.go:2400:primaryExpression: expr.go:463:expr0: expr.go:1069:unaryExpression)
	...
	`assets/gcc-9.1.0/gcc/testsuite/gcc.c-torture/execute/strct-stdarg-1.c`:                             {}, // COMPILE FAIL: unsupported va_arg type: struct (expr.go:2400:primaryExpression: expr.go:463:expr0: expr.go:1069:unaryExpression)
	`assets/gcc-9.1.0/gcc/testsuite/gcc.c-torture/execute/strct-varg-1.c`:                               {}, // COMPILE FAIL: unsupported va_arg type: struct (expr.go:2400:primaryExpression: expr.go:463:expr0: expr.go:1069:unaryExpression)
	...
	`assets/gcc-9.1.0/gcc/testsuite/gcc.c-torture/execute/va-arg-pack-1.c`:                              {}, // COMPILE FAIL: unsupported va_arg type: struct (expr.go:2400:primaryExpression: expr.go:463:expr0: expr.go:1069:unaryExpression)
	...
	`assets/github.com/gcc-mirror/gcc/gcc/testsuite/gcc.c-torture/execute/20020412-1.c`:                 {}, // COMPILE FAIL: unsupported va_arg type: struct (expr.go:2400:primaryExpression: expr.go:463:expr0: expr.go:1069:unaryExpression)
	...
	`assets/github.com/gcc-mirror/gcc/gcc/testsuite/gcc.c-torture/execute/20030714-1.c`:                 {}, // COMPILE FAIL: TODO PostfixExpressionSelect (expr.go:455:expr0: expr.go:1361:postfixExpression: expr.go:1792:postfixExpressionSelect)
	...
	`assets/github.com/gcc-mirror/gcc/gcc/testsuite/gcc.c-torture/execute/20030910-1.c`:                 {}, // COMPILE FAIL: TODO UnaryExpressionReal (expr.go:2400:primaryExpression: expr.go:463:expr0: expr.go:1152:unaryExpression)
	...
	`assets/github.com/gcc-mirror/gcc/gcc/testsuite/gcc.c-torture/execute/20070614-1.c`:                 {}, // COMPILE FAIL: TODO cc.Complex64Value (expr.go:457:expr0: expr.go:2390:primaryExpression: expr.go:2658:primaryExpressionFloatConst)
	...
	`assets/github.com/gcc-mirror/gcc/gcc/testsuite/gcc.c-torture/execute/920625-1.c`:                   {}, // COMPILE FAIL: unsupported va_arg type: struct (expr.go:2400:primaryExpression: expr.go:463:expr0: expr.go:1069:unaryExpression)
	...
	`assets/github.com/gcc-mirror/gcc/gcc/testsuite/gcc.c-torture/execute/920908-1.c`:                   {}, // COMPILE FAIL: unsupported va_arg type: struct (expr.go:2400:primaryExpression: expr.go:463:expr0: expr.go:1069:unaryExpression)
	...
	`assets/github.com/gcc-mirror/gcc/gcc/testsuite/gcc.c-torture/execute/931004-10.c`:                  {}, // COMPILE FAIL: unsupported va_arg type: struct (expr.go:2400:primaryExpression: expr.go:463:expr0: expr.go:1069:unaryExpression)
	`assets/github.com/gcc-mirror/gcc/gcc/testsuite/gcc.c-torture/execute/931004-14.c`:                  {}, // COMPILE FAIL: unsupported va_arg type: struct (expr.go:2400:primaryExpression: expr.go:463:expr0: expr.go:1069:unaryExpression)
	`assets/github.com/gcc-mirror/gcc/gcc/testsuite/gcc.c-torture/execute/931004-12.c`:                  {}, // COMPILE FAIL: unsupported va_arg type: struct (expr.go:2400:primaryExpression: expr.go:463:expr0: expr.go:1069:unaryExpression)
	`assets/github.com/gcc-mirror/gcc/gcc/testsuite/gcc.c-torture/execute/931004-2.c`:                   {}, // COMPILE FAIL: unsupported va_arg type: struct (expr.go:2400:primaryExpression: expr.go:463:expr0: expr.go:1069:unaryExpression)
	`assets/github.com/gcc-mirror/gcc/gcc/testsuite/gcc.c-torture/execute/931004-4.c`:                   {}, // COMPILE FAIL: unsupported va_arg type: struct (expr.go:2400:primaryExpression: expr.go:463:expr0: expr.go:1069:unaryExpression)
	`assets/github.com/gcc-mirror/gcc/gcc/testsuite/gcc.c-torture/execute/931004-6.c`:                   {}, // COMPILE FAIL: unsupported va_arg type: struct (expr.go:2400:primaryExpression: expr.go:463:expr0: expr.go:1069:unaryExpression)
	`assets/github.com/gcc-mirror/gcc/gcc/testsuite/gcc.c-torture/execute/931004-8.c`:                   {}, // COMPILE FAIL: unsupported va_arg type: struct (expr.go:2400:primaryExpression: expr.go:463:expr0: expr.go:1069:unaryExpression)
	...
	`assets/github.com/gcc-mirror/gcc/gcc/testsuite/gcc.c-torture/execute/960416-1.c`:                   {}, // COMPILE FAIL: gcc.c-torture/execute/960416-1.c:57:23: internal error: t_be (expr.go:2388:primaryExpression: expr.go:2645:primaryExpressionIntConst: type.go:27:helper)
	...
	`assets/github.com/gcc-mirror/gcc/gcc/testsuite/gcc.c-torture/execute/991014-1.c`:                   {}, // COMPILE FAIL: 991014-1.c:10:1: invalid type size: -496 (type.go:385:structLiteral: type.go:52:typ0: type.go:369:checkValidType)
	...
	`assets/github.com/gcc-mirror/gcc/gcc/testsuite/gcc.c-torture/execute/anon-1.c`:                     {}, // COMPILE FAIL: TODO PostfixExpressionSelect (expr.go:455:expr0: expr.go:1361:postfixExpression: expr.go:1783:postfixExpressionSelect)
	...
	`assets/github.com/gcc-mirror/gcc/gcc/testsuite/gcc.c-torture/execute/built-in-setjmp.c`:            {}, // COMPILE FAIL: built-in-setjmp.c.go:332:5: undefined reference to '__builtin_setjmp' (ccgo.go:263:Main: link.go:246:link: link.go:614:link)
	`assets/github.com/gcc-mirror/gcc/gcc/testsuite/gcc.c-torture/execute/builtin-bitops-1.c`:           {}, // COMPILE FAIL: builtin-bitops-1.c.go:1636:56: undefined reference to '__builtin_ctzll' (ccgo.go:263:Main: link.go:246:link: link.go:614:link)
	`assets/github.com/gcc-mirror/gcc/gcc/testsuite/gcc.c-torture/execute/builtin-types-compatible-p.c`: {}, // COMPILE FAIL: TODO *cc.InvalidType (expr.go:455:expr0: expr.go:1358:postfixExpression: expr.go:1937:postfixExpressionCall)
	...
	`assets/github.com/gcc-mirror/gcc/gcc/testsuite/gcc.c-torture/execute/complex-2.c`:                  {}, // COMPILE FAIL: TODO cc.Complex128Value (expr.go:457:expr0: expr.go:2390:primaryExpression: expr.go:2658:primaryExpressionFloatConst)
	`assets/github.com/gcc-mirror/gcc/gcc/testsuite/gcc.c-torture/execute/complex-7.c`:                  {}, // COMPILE FAIL: TODO cc.Complex64Value (expr.go:457:expr0: expr.go:2390:primaryExpression: expr.go:2658:primaryExpressionFloatConst)
	...
	`assets/github.com/gcc-mirror/gcc/gcc/testsuite/gcc.c-torture/execute/complex-5.c`:                  {}, // COMPILE FAIL: TODO cc.Complex64Value (expr.go:457:expr0: expr.go:2390:primaryExpression: expr.go:2658:primaryExpressionFloatConst)
	`assets/github.com/gcc-mirror/gcc/gcc/testsuite/gcc.c-torture/execute/complex-6.c`:                  {}, // COMPILE FAIL: TODO cc.Complex128Value (expr.go:457:expr0: expr.go:2390:primaryExpression: expr.go:2658:primaryExpressionFloatConst)
	...
	`assets/github.com/gcc-mirror/gcc/gcc/testsuite/gcc.c-torture/execute/ieee/fp-cmp-4.c`:              {}, // COMPILE FAIL: fp-cmp-4.c.go:329:5: undefined reference to '__builtin_isless' (ccgo.go:263:Main: link.go:246:link: link.go:614:link)
	...
	`assets/github.com/gcc-mirror/gcc/gcc/testsuite/gcc.c-torture/execute/ieee/fp-cmp-4f.c`:             {}, // COMPILE FAIL: fp-cmp-4f.c.go:342:5: undefined reference to '__builtin_islessequal' (ccgo.go:263:Main: link.go:246:link: link.go:614:link)
	...
	`assets/github.com/gcc-mirror/gcc/gcc/testsuite/gcc.c-torture/execute/ieee/fp-cmp-8.c`:              {}, // COMPILE FAIL: fp-cmp-8.c.go:406:5: undefined reference to '__builtin_isgreaterequal' (ccgo.go:263:Main: link.go:246:link: link.go:614:link)
	`assets/github.com/gcc-mirror/gcc/gcc/testsuite/gcc.c-torture/execute/ieee/fp-cmp-8f.c`:             {}, // COMPILE FAIL: fp-cmp-8f.c.go:406:5: undefined reference to '__builtin_isgreaterequal' (ccgo.go:263:Main: link.go:246:link: link.go:614:link)
	`assets/github.com/gcc-mirror/gcc/gcc/testsuite/gcc.c-torture/execute/ieee/fp-cmp-8l.c`:             {}, // COMPILE FAIL: fp-cmp-8l.c.go:405:5: undefined reference to '__builtin_isgreaterequal' (ccgo.go:263:Main: link.go:246:link: link.go:614:link)
	`assets/github.com/gcc-mirror/gcc/gcc/testsuite/gcc.c-torture/execute/ieee/mzero4.c`:                {}, // COMPILE FAIL: mzero4.c.go:356:18: undefined reference to 'tanf' (ccgo.go:263:Main: link.go:246:link: link.go:614:link)
	`assets/github.com/gcc-mirror/gcc/gcc/testsuite/gcc.c-torture/execute/ieee/pr38016.c`:               {}, // COMPILE FAIL: pr38016.c.go:428:5: undefined reference to '__builtin_islessgreater' (ccgo.go:263:Main: link.go:246:link: link.go:614:link)
	...
	`assets/github.com/gcc-mirror/gcc/gcc/testsuite/gcc.c-torture/execute/pr39228.c`:                    {}, // COMPILE FAIL: pr39228.c.go:320:9: undefined reference to '__builtin_isinff' (ccgo.go:263:Main: link.go:246:link: link.go:614:link)
	...
	`assets/github.com/gcc-mirror/gcc/gcc/testsuite/gcc.c-torture/execute/pr44575.c`:                    {}, // COMPILE FAIL: unsupported va_arg type: struct (expr.go:2400:primaryExpression: expr.go:463:expr0: expr.go:1069:unaryExpression)
	`assets/github.com/gcc-mirror/gcc/gcc/testsuite/gcc.c-torture/execute/pr47237.c`:                    {}, // COMPILE FAIL: pr47237.c.go:328:46: undefined reference to '__builtin_apply_args' (ccgo.go:263:Main: link.go:246:link: link.go:614:link)
	...
	`assets/github.com/gcc-mirror/gcc/gcc/testsuite/gcc.c-torture/execute/pr49644.c`:                    {}, // COMPILE FAIL: TODO cc.Complex128Value (expr.go:457:expr0: expr.go:2390:primaryExpression: expr.go:2658:primaryExpressionFloatConst)
	...
	`assets/github.com/gcc-mirror/gcc/gcc/testsuite/gcc.c-torture/execute/pr64242.c`:                    {}, // COMPILE FAIL: pr64242.c.go:337:33: undefined reference to '__builtin_alloca' (ccgo.go:263:Main: link.go:246:link: link.go:614:link)
	...
	`assets/github.com/gcc-mirror/gcc/gcc/testsuite/gcc.c-torture/execute/pr80692.c`:                    {}, // COMPILE FAIL: TODO *cc.PredefinedType _Decimal64 _Decimal64 (expr.go:2654:primaryExpressionFloatConst: type.go:29:helper: type.go:141:typ0)
	...
	`assets/github.com/gcc-mirror/gcc/gcc/testsuite/gcc.c-torture/execute/pr84521.c`:                    {}, // COMPILE FAIL: pr84521.c.go:318:2: undefined reference to '__builtin_longjmp' (ccgo.go:263:Main: link.go:246:link: link.go:614:link)
	...
	`assets/github.com/gcc-mirror/gcc/gcc/testsuite/gcc.c-torture/execute/printf-2.c`:                   {}, // COMPILE FAIL: printf-2.c.go:4516:8: undefined reference to 'freopen' (ccgo.go:263:Main: link.go:246:link: link.go:614:link)
	`assets/github.com/gcc-mirror/gcc/gcc/testsuite/gcc.c-torture/execute/stdarg-3.c`:                   {}, // COMPILE FAIL: unsupported va_arg type: struct (expr.go:2400:primaryExpression: expr.go:463:expr0: expr.go:1069:unaryExpression)
	...
	`assets/github.com/gcc-mirror/gcc/gcc/testsuite/gcc.c-torture/execute/strct-stdarg-1.c`:             {}, // COMPILE FAIL: unsupported va_arg type: struct (expr.go:2400:primaryExpression: expr.go:463:expr0: expr.go:1069:unaryExpression)
	`assets/github.com/gcc-mirror/gcc/gcc/testsuite/gcc.c-torture/execute/strct-varg-1.c`:               {}, // COMPILE FAIL: unsupported va_arg type: struct (expr.go:2400:primaryExpression: expr.go:463:expr0: expr.go:1069:unaryExpression)
	...
	`assets/github.com/gcc-mirror/gcc/gcc/testsuite/gcc.c-torture/execute/va-arg-pack-1.c`:              {}, // COMPILE FAIL: unsupported va_arg type: struct (expr.go:2400:primaryExpression: expr.go:463:expr0: expr.go:1069:unaryExpression)
	...
	`assets/github.com/vnmakarov/mir/c-tests/andrewchambers_c/0028-inits13.c`:                           {}, // COMPILE FAIL: TODO PostfixExpressionSelect (expr.go:455:expr0: expr.go:1361:postfixExpression: expr.go:1783:postfixExpressionSelect)
	...
	`assets/github.com/vnmakarov/mir/c-tests/andrewchambers_c/0028-inits15.c`:                           {}, // COMPILE FAIL: TODO PostfixExpressionSelect (expr.go:455:expr0: expr.go:1361:postfixExpression: expr.go:1783:postfixExpressionSelect)
	`assets/github.com/vnmakarov/mir/c-tests/lacc/anonymous-struct.c`:                                   {}, // COMPILE FAIL: TODO PostfixExpressionSelect (expr.go:455:expr0: expr.go:1361:postfixExpression: expr.go:1783:postfixExpressionSelect)
	...
	`assets/github.com/vnmakarov/mir/c-tests/lacc/deref-compare-float.c`:                                {}, // COMPILE FAIL: TODO "((iqlibc.ppFloat64FromFloat64(0)) > (iqlibc.ppFloat64FromInt32((*(*ppint32)(iqunsafe.ppPointer(Xi))))))" int exprBool -> float exprDefault (expr.go:2085:assignmentExpression: expr.go:69:expr: expr.go:139:convert)
	...
	`assets/github.com/vnmakarov/mir/c-tests/lacc/float-compare-equal.c`:                                {}, // COMPILE FAIL: TODO "((iqlibc.ppFloat32FromInt32(Xi)) == (*(*ppfloat32)(iqunsafe.ppPointer(Xf))))" int exprBool -> float exprDefault (expr.go:2085:assignmentExpression: expr.go:69:expr: expr.go:139:convert)
	`assets/github.com/vnmakarov/mir/c-tests/lacc/function-incomplete.c`:                                {}, // COMPILE FAIL: function-incomplete.c:6:9: too few arguments to function 'foo', type 'function(pointer to char) returning int' in 'foo()' (expr.go:455:expr0: expr.go:1358:postfixExpression: expr.go:1952:postfixExpressionCall)
	...
	`assets/github.com/vnmakarov/mir/c-tests/lacc/string-addr.c`:                                        {}, // COMPILE FAIL: TODO (expr.go:457:expr0: expr.go:2396:primaryExpression: expr.go:2513:primaryExpressionStringConst)
	`assets/github.com/vnmakarov/mir/c-tests/lacc/stringify.c`:                                          {}, // COMPILE FAIL: TODO `'\xA'` -> invalid syntax (expr.go:457:expr0: expr.go:2392:primaryExpression: expr.go:2586:primaryExpressionCharConst)
	...
	`assets/github.com/vnmakarov/mir/c-tests/lacc/vararg-complex-1.c`:                                   {}, // COMPILE FAIL: unsupported va_arg type: struct (expr.go:2400:primaryExpression: expr.go:463:expr0: expr.go:1069:unaryExpression)
	`assets/github.com/vnmakarov/mir/c-tests/lacc/vararg-complex-2.c`:                                   {}, // COMPILE FAIL: unsupported va_arg type: struct (expr.go:2400:primaryExpression: expr.go:463:expr0: expr.go:1069:unaryExpression)
	`assets/github.com/vnmakarov/mir/c-tests/lacc/vararg.c`:                                             {}, // COMPILE FAIL: unsupported va_arg type: struct (expr.go:2400:primaryExpression: expr.go:463:expr0: expr.go:1069:unaryExpression)
	...
	`assets/github.com/vnmakarov/mir/c-tests/new/issue142.c`:                                            {}, // COMPILE FAIL: unsupported va_arg type: struct (expr.go:2400:primaryExpression: expr.go:463:expr0: expr.go:1069:unaryExpression)
	...
	`assets/tcc-0.9.27/tests/tests2/87_dead_code.c`:                                                     {}, // COMPILE FAIL: 87_dead_code.c:17:9: TODO false (expr.go:457:expr0: expr.go:2406:primaryExpression: stmt.go:107:compoundStatement)
	...
	`assets/tcc-0.9.27/tests/tests2/94_generic.c`:                                                       {}, // COMPILE FAIL: TODO PrimaryExpressionGeneric (expr.go:61:expr: expr.go:457:expr0: expr.go:2415:primaryExpression)
