...
var testExecKnownFails = map[string]struct{}{
	...
	`assets/gcc-9.1.0/gcc/testsuite/gcc.c-torture/execute/20020412-1.c`:                                 {}, // COMPILE FAIL: unsupported va_arg type: struct (expr.go:2407:primaryExpression: expr.go:463:expr0: expr.go:1069:unaryExpression)
