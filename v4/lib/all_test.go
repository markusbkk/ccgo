...
var testExecKnownFails = map[string]struct{}{
	...
	//TODO fail at compile time, dtto for pthread_*
	`assets/github.com/vnmakarov/mir/c-tests/new/setjmp.c`:  {}, // EXEC FAIL
	`assets/github.com/vnmakarov/mir/c-tests/new/setjmp2.c`: {}, // EXEC FAIL
